function p=plotCategorization2withModelFig3(MIX2,Pc2, semPerf,t_data, sigma_data, p_model_1, t_model_1, Number_trials, p_model_2, t_model_2)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%amendonca
...
% [y,~,~,~]=nlinfit(MIX2,t_model,tT,[0, 4.5, 0.5 100]);
